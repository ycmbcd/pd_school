...
<div class="table_list" style="width:684px;margin-left:64px;">
	<ul>
      ...
      <li class="title_table" style="width:100px;">日本库存</li>
      <li class="title_table" style="width:100px;">日本阈值</li>
      <div class="clear"></div>
    </ul>
    {foreach $resu as $se}
  	<ul>
      ...
      <li style="width:100px;">{$se.b_repo}</li>
      <li style="width:100px;">{$se.b_warning}</li>
      <div class="clear"></div>
  	</ul>
    {/foreach}
</div>
