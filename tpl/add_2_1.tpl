...
function change_order(){
  ...
  if(order_id=="0"){
    window.location.href="/right/add_2_1.php";
  }else{
    window.location.href="/right/add_2_1.php?change_order="+order_id;    
  }
  ...
  var order_id=$("#order_select").val();
    ...
    return false;
		...
		$.ajax({
            ...
            self.location="/right/add_2_1.php";
					});
				}else{
					$(".txt_msg").html("系统出错！");
					$(".msg").css({"background":"#F66","border-color":"#C33","color":"#FFF"});
...
<div id="top_bar">
  <div id="big_show" class="f_left">- 安藤库存管理系统 - 采购清单（中国）</div>
  <div class="f_right">
