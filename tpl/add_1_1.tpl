  ...
  function makeup(){
    $.ajax({
        ...
        success:function(data){
          if(data=="ok"){
            window.location="/down/china_import.xlsx";
          }else{            
            alert("系统出错，请联系管理员！");
          }
              },
...
<div style="width:100%;background:#eee;position:fixed;top:0px;left:0px;color:#000;">
  <div style="margin-left:50px;margin-top:40px;padding-bottom:10px;">
    ...
    <div style="margin-top:10px;position:relative;">
      <form action="add_1_1.php" method="post" enctype="multipart/form-data">
      <input class="scan_file" type="file" name="file" value="浏览" style="width:200px;background:#eee;margin-right:6px;" />
      <input class="btn_green" id="btn_import" type="submit" value="导 入" onclick="start_import()" name="uploads" />
      </form>
    </div>
    <div style="margin-top:10px;">
      <div class="f_left" style="font-size:16px;height:30px;line-height:30px;padding-right:6px;">
      已经导入：</div>
      <div class="btn_gray f_left" onClick="self.location='add_1_2.php'; ">查 看</div>
      <div class="clear"></div>
    </div>
  </div>
</div>
