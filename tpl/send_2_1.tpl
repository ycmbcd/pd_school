...
$(document).ready(function(){
  ...
  function change_date(){
    ...
    window.location.href="/right/send_2_1.php?change_date=yes&a_date="+a_date+"&b_date="+b_date;
     $("#a_date").val("a_date");
     $("#b_date").val("b_date");
  }
  //判断日期还是选择状态
...
<div id="top_bar">
  ...
  <div class="f_right">
    ...
    <div class="btn_blue f_left ml10" onclick="import_change()">日→中</div>
