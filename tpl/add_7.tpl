...
function change_order(){
  ...
  if(order_id=="0"){
    window.location.href="/right/add_7.php";
  }else{
    window.location.href="/right/add_7.php?change_order="+order_id;
  }
}
//入库
function in_repo(){
...
<div id="top_bar">
  <div id="big_show" class="f_left">- 安藤库存管理系统 - 采购入库（日本）</div>
  <div class="f_right">
